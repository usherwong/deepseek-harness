...
export const en = {
  ...
  startupFailed: 'DeepSeek Desktop could not start',
  startupLoading: 'Starting DeepSeek Desktop…',
...
export const zh = {
  application: '应用',
  startupFailed: 'DeepSeek Desktop 无法启动',
  startupLoading: '正在启动 DeepSeek Desktop…',
  ...
  updateTitle: 'DeepSeek Desktop 更新',
  ...
  pluginWindowTitle: 'DeepSeek Desktop — 桌面插件',
