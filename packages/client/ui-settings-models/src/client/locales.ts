...
export const en = {
  ...
  retry: 'Retry',
  keyInput: 'API key',
  vlKeyInput: 'Bailian (DashScope) API key',
  vlBackend: 'Vision model',
  vlBackendDeepseek: 'DeepSeek (deepseek-v4-flash-vision-exp)',
  vlBackendBailian: 'Bailian (qwen3.7-plus)',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  retry: '重试',
  keyInput: 'API 密钥',
  vlKeyInput: '百炼（DashScope）API 密钥',
  vlBackend: '视觉模型',
  vlBackendDeepseek: 'DeepSeek（deepseek-v4-flash-vision-exp）',
  vlBackendBailian: '百炼（qwen3.7-plus）',
